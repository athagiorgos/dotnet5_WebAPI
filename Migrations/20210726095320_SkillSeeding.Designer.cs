...
namespace dotnet5_WebAPI.Migrations
{
    ...
    [Migration("20210726095320_SkillSeeding")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnet5_WebAPI.Models.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CharacterSkill", b =>
                {
                    b.HasOne("dotnet5_WebAPI.Models.Character", null)
                        .WithMany()
                        .HasForeignKey("CharactersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("dotnet5_WebAPI.Models.Skill", null)
                        .WithMany()
            ...
            modelBuilder.Entity("dotnet5_WebAPI.Models.Character", b =>
                {
                    b.HasOne("dotnet5_WebAPI.Models.User", "User")
                        .WithMany("Characters")
